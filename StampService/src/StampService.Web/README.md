...
3. Выбрать конфигурацию `Web: открыть в браузере`.
4. Нажать Start.

VS Code запустит Vite dev server. Если `node_modules` ещё нет, зависимости будут установлены автоматически перед стартом.
