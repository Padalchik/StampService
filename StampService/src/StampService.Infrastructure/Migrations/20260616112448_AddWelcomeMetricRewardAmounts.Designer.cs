...
namespace StampService.Infrastructure.Migrations
{
    ...
    [Migration("20260616112448_AddWelcomeMetricRewardAmounts")]
    partial class AddWelcomeMetricRewardAmounts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StampService.Domain.Audit.BusinessAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("BrandId", "OccurredAt");

                    b.HasIndex("CustomerUserId", "OccurredAt");

                    b.HasIndex("OperationType", "OperationStatus", "OccurredAt");

                    b.ToTable("business_audit_logs", null, t =>
                        {
                            t.HasCheckConstraint("ck_business_audit_logs_operation_status", "operation_status IN ('Succeeded', 'Rejected', 'Failed')");
                        });
                });
            ...
            modelBuilder.Entity("StampService.Domain.User.PhoneAuthSmsSettings", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
                    ...
                    b.ToTable("phone_auth_sms_settings", null, t =>
                        {
                            t.HasCheckConstraint("ck_phone_auth_sms_settings_singleton", "id = 1");
                        });
                });
