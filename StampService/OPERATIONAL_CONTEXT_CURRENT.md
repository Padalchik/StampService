...
- если клиент не выбран, рабочая зона показывает форму поиска по телефону;
...
- если клиент найден, рабочая зона показывает карточку клиента и операции над выбранным клиентом;
- карточка клиента показывает имя, телефон и блок `Штампы` / `Монетки` / `История`;
...
- `BrandWorkspace` отвечает за рабочую область уже выбранного бренда: состояние поиска клиента, выбранную карточку клиента, операционные панели и переход в экран настроек бренда;
...
- рабочая зона показывает только один активный сценарий: поиск клиента или карточку выбранного клиента с операциями;
